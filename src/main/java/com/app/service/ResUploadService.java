...
public class ResUploadService {
    ...
    public String upload(MultipartFile multipartFile, String dirName, int res_id) throws IOException {
        String fileName = multipartFile.getOriginalFilename();
        String newDirName = "restaurant_images";
        String newFileName = "res" + res_id + ".png";
        String fileKey = "restaurant_images/res" + res_id+ ".png";
//      https://kr.object.ncloudstorage.com/team2-bucket/restaurant_images/res001.png
