        ...
        <body>
            <div class="container mt-2" id="resContainer">
                ...
                <div class="buttons mt-4">
                    <button class="btn btn-primary mb-4 mx-2 category find_res" id="find_res">
                    ...
                    <button class="btn btn-primary mb-4 category" style="display: flex; float:right;"
                        id="deleteAll"><img src="images/icon/delete_icon.png" width="26" height="26">&nbsp; 선택 항목 삭제하기
                    </button>
                    <button class="btn btn-primary category mx-3" style="display: flex; float:right;" id="allCheck"><img
                            src="images/icon/check_icon.png" width="27" height="27">&nbsp;<span id="checkText"> 전체
                            선택</span></button>
                </div>
                                            ...
                                            <div class="card-body">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="checkbox" name="check" class="check"
                                                        value="${dto.res_id}" style="display: none;">
                                                    <br>
                                                </div>
                                                ...
                                                <button class="btn btn-primary mb-3 deleteBtn" style="float: right;"
                                                    data-id="${dto.res_id}" data-type="restaurant">삭제</button>
                                        ...
                                        <div class="col-md-8">
                                            <div class="card-body">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="checkbox" name="check" class="check"
                                                        value="${dto.lodging_id}" style="display: none;">
                                                    <br>
                                                </div>
                                                <img src="images/icon/icon1.png" width="13" height="13"><span
                                                ...
                                                <span id="rating">&nbsp;${dto.rating}</span>
                                                <button class="btn btn-primary mb-3 deleteBtn" style="float: right;"
                                                    data-id="${dto.lodging_id}" data-type="lodging">삭제</button>
