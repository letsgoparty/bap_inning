                ...
                success: function (data) {
                    ...
                    $.each(data, function (idx, ele) {
                        ...
                        var cardHtml = '<form id="' + cardId + '" action="l_reviewList" method="get">' +
                            ...
                            '<p></p>' +
                            '<img src="images/icon/icon2.png" width="13" height="13"><span style="font-family: \'KBO-Dia-Gothic_light\';">&nbsp;<span class="location">한화생명 이글스파크</span>에서 <span id="distance">' + ele.distance + '</span></span>' +
                            '</div>' +
                            '<p></p>' +
                            '<img src="images/icon/icon3.png" width="13" height="13"><span>&nbsp;' + 4.5 + '</span>' +
    ...
    $(document).on('click', '.find_lod_btn', function (event) {
	 ...
	 $('#containerDiv').addClass('container');
            function initMap() {
                ...
                // 대전 한화생명 이글스파크
                var mapOptions = {
                    center: new google.maps.LatLng(36.324276, 127.428403),
                    zoom: 15.6 /* 음식점 & 숙소 마커 포함 이후 zoom 확대 예정 */
                };
                ...
                const locations = [
                    ...
                    { place: "베스트인시티호텔", lat: 36.3200583, lng: 127.4313426 },
                    { place: "호텔썸", lat: 36.3223673, lng: 127.4330932 },
                    { place: "호텔 더리즈", lat: 36.3222732, lng: 127.4339226 },
                    { place: "베니키아호텔대림", lat: 36.3284919, lng: 127.4224499 },
                    { place: "만월호텔 대흥점", lat: 36.326393, lng: 127.429146 },
                    { place: "나인스팟호텔", lat: 36.329198, lng: 127.423742 },
                    { place: "산토리니 모텔", lat: 36.320639, lng: 127.430946 },
                    { place: "띠아모모텔", lat: 36.321177, lng: 127.432515 },
                    { place: "로즈마리", lat: 36.319371, lng: 127.430513 },
                    { place: "스타모텔", lat: 36.322616, lng: 127.429866 },
                    { place: "자우리모텔", lat: 36.324596, lng: 127.423686 },
