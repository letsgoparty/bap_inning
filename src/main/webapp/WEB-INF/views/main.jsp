...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top">
        <div class="container px-5">
            <a class="navbar-brand" href="main"><img src="images/mainlogo.PNG" width="170" height="70"></a>
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ms-auto">
                    ...
                    <div class="dropdown me-auto mb-2 mb-lg-0 mx-2 mt-2">
                        ...
                        <ul class="dropdown-menu" style="font-family: 'KBO-Dia-Gothic_bold';">
                            <li style="display: flex; align-items: center;"><img src="images/logo/SSG.png" alt="Logo" width="30" height="30"><a
                                    class="dropdown-item" href="#">SSG 랜더스</a></li>
                            <li style="display: flex; align-items: center;"><img src="images/logo/키움.png" alt="Logo" width="30" height="30"><a
                                    class="dropdown-item" href="#">키움 히어로즈</a></li>
                            <li style="display: flex; align-items: center;"><img src="images/logo/LG.png" alt="Logo" width="30" height="30"><a
                                    class="dropdown-item" href="#">LG 트윈스</a></li>
                            <li style="display: flex; align-items: center;"><img src="images/logo/KT.png" alt="Logo" width="30" height="30"><a
                                    class="dropdown-item" href="#">KT wiz</a></li>
                            <li style="display: flex; align-items: center;"><img src="images/logo/KIA.png" alt="Logo" width="30" height="30"><a
                                    class="dropdown-item" href="#">KIA 타이거즈</a></li>
                            <li style="display: flex; align-items: center;"><img src="images/logo/NC.png" alt="Logo" width="30" height="30"><a
                                    class="dropdown-item" href="#">NC 다이노스</a></li>
                            <li style="display: flex; align-items: center;"><img src="images/logo/삼성.png" alt="Logo" width="30" height="35"><a
                                    class="dropdown-item" href="#">삼성 라이온즈</a></li>
                            <li style="display: flex; align-items: center;"><img src="images/logo/롯데.png" alt="Logo" width="30" height="30"><a
                                    class="dropdown-item" href="#">롯데 자이언츠</a></li>
                            <li style="display: flex; align-items: center;"><img src="images/logo/두산.png" alt="Logo" width="30" height="30"><a
                                    class="dropdown-item" href="#">두산 베어스</a></li>
                            <li style="display: flex; align-items: center;"><img src="images/logo/한화.png" alt="Logo" width="30" height="30"><a
                                    class="dropdown-item" href="#">한화 이글스</a></li>
                        </ul>
                    </div>
                    &nbsp&nbsp&nbsp&nbsp&nbsp
                    <li class="nav-item mx-2 mt-3"><a class="btn btn-primary" href="loginForm" role="button" >로그인</a></li>
                    <li class="nav-item mx-2 mt-3"><a class="btn btn-primary" href="memberForm" role="button">회원가입</a></li>
    ...
    <header class="masthead text-center text-white">
        <div class="masthead-content">
            <div class="container px-5">
                <h1 class="masthead-heading mb-0" style="font-family: 'KBO-Dia-Gothic_bold';">야구 보러가자!</h1>
                <p class="masthead-subheading mb-0" style="font-size: 1.3rem; font-family: 'KBO-Dia-Gothic_light';">맛집과 숙소를 한눈에👀 볼 수 있는 밥이닝</p>
                <a class="btn btn-primary btn-xl rounded-pill mt-5" href="#scroll" style="font-size: 1.3rem; font-family: 'KBO-Dia-Gothic_light';">경기일정 및 순위 보러가기</a>
            </div>
        </div>
    </header>
...
<div class="row">
                ...
                <c:forEach var="schedule" items="${ScheduleList}">
                    <tr>
                        ...
                        <td>
                            ...
                            ${schedule.team1}&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                            <c:choose>
                            ...
                            &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp ${schedule.team2}
                        </td>
                        <td>
                            <c:choose>
    ...
    <div class="col-md-4 offset-md-1 pt-5">
        ...
        <table class="table table-striped" style="font-family: 'KBO-Dia-Gothic_light';">
            <thead>
            ...
            <tbody>
                <c:forEach var="team" items="${teamDataList}">
                    <tr>
                        ...
                        <td style="font-family: 'KBO-Dia-Gothic_bold';"><img src="images/logo/${team.image}.png"
                                width="25" height="25">
                            ${team.title}</td>
                        <td>${team.match}</td>
                        <td>${team.victory}</td>
