								...
								<div class="pagination">
									<ul class="pagination">
										...
										<li
											...
											<a class="page-link"
											href="my_l_review?curPage=1&amount=${pageDTO.amount}">&laquo;</a>
										</li>

										<li class="page-item ${pageDTO.prev ? '' : 'disabled'}">
											<a class="page-link"
											href="my_l_review?curPage=${pageDTO.startPage-1}&amount=${pageDTO.amount}">&lsaquo;</a>
										</li>
										...
										<c:forEach var="num" begin="${pageDTO.startPage}"
											...
											<li
												...
												<a class="page-link"
												href="my_l_review?curPage=${num}&amount=${pageDTO.amount}">${num}</a>
											</li>
										</c:forEach>
										...
										<li class="page-item ${pageDTO.next ? '' : 'disabled'}">
											<a class="page-link"
											href="my_l_review?curPage=${pageDTO.endPage+1}&amount=${pageDTO.amount}">&rsaquo;</a>
										</li>
										...
										<li
											...
											<a class="page-link"
											href="my_l_review?curPage=${pageDTO.realEnd}&amount=${pageDTO.amount}">&raquo;</a>
										</li>
...
for (let i=0;i<radioButton.length;i++){
	...
	function confirmDelete(review_id,curPage,amount){
		...
		if(confirmation){
			//확인 눌렀을때 진짜 삭제하기
			window.location.href="delete_my_l_review?num="+review_id+ "&curPage=" + curPage + "&amount=" + amount;
		}
	}
	</script>
