								...
								<div class="pagination">
									<ul class="pagination">
										...
										<li
											...
											<a class="page-link"
											href="mytext?curPage=1&amount=${pageDTO.amount}">&laquo;</a>
										</li>

										<li class="page-item ${pageDTO.prev ? '' : 'disabled'}">
											<a class="page-link"
											href="mytext?curPage=${pageDTO.startPage-1}&amount=${pageDTO.amount}">&lsaquo;</a>
										</li>
										...
										<c:forEach var="num" begin="${pageDTO.startPage}"
											...
											<li
												...
												<a class="page-link"
												href="mytext?curPage=${num}&amount=${pageDTO.amount}">${num}</a>
											</li>
										</c:forEach>
										...
										<li class="page-item ${pageDTO.next ? '' : 'disabled'}">
											<a class="page-link"
											href="mytext?curPage=${pageDTO.endPage+1}&amount=${pageDTO.amount}">&rsaquo;</a>
										</li>
										...
										<li
											...
											<a class="page-link"
											href="mytext?curPage=${pageDTO.realEnd}&amount=${pageDTO.amount}">&raquo;</a>
										</li>
...
/* 		"my_r_review",//식당리뷰
	...
	<script>
	//삭제 눌렀을때 팝업으로 확인하기
	function confirmDelete(boardNum,curPage,amount){
		var confirmation=confirm("게시글을 삭제하시겠습니까?");
		if(confirmation){
			//확인 눌렀을때 진짜 삭제하기
			window.location.href="delete_mytext?no="+boardNum+ "&curPage=" + curPage + "&amount=" + amount;
		}
	}
	</script>
