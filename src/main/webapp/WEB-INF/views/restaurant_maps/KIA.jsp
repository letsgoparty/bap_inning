				...
				<div class="card-body">
					...
					<div class="">
						...
						<img src="images/icon/icon2.png" width="13" height="13"><span
							style="font-family: 'KBO-Dia-Gothic_light';">&nbsp;<span style="font-family: 'KBO-Dia-Gothic_bold">광주 KIA 챔피언스 필드</span>에서 걸어서 <span id="distance"
							style="font-family: 'KBO-Dia-Gothic_bold'; color: rgb(146, 16, 16);"></span> 분
						</span>
					</div>
					<p></p>
